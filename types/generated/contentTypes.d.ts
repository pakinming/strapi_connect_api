...
export interface ApiAudioListAudioList extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'audio_list';
    pluralName: 'audio-lists';
    singularName: 'audio-list';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRoutePoiRoutePoi extends Struct.CollectionTypeSchema {
  collectionName: 'route_pois';
  info: {
    displayName: 'route_poi';
    pluralName: 'route-pois';
    singularName: 'route-poi';
  };
  options: {
    draftAndPublish: true;
  };
